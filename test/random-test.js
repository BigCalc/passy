...
describe('random', function() {
  ...
  it('should be uniformly distributed', function() {
    var charset, id, k, lower, m, n, result, upper;
    m = n = 640000;
    result = {};
  ...
  describe('#verify', function() {
    ...
    it('should return false on non ALPHABET characters', function() {
      var specialChars = '±!@£$%^&*()+=[]{};:\'"|?/,.<>/?~`¡€#¢∞§¶•ªº–≠‘“πø^¨¥†®∑œåß∂ƒ©˙' +
                         '∆˚¬…æ«÷≥≤µ~∫√ç≈Ωé⁄™‹›ﬁﬂ‡°·‚—±’”∏ØÈËÁÊÂ‰„ŒÅÍÎÏÌÓÔÒÚÆ»¿˘¯˜ˆı◊ÇÙÛŸ',
    ...
    it('should return true on ALPHABET characters', function() {
      ...
      var trues = ['hed', 'JDH', '234', '-_',
                   'asdJHK334-_', '-_234sdfLKJ',
